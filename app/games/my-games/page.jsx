  ...
  return (
    <div className={`${className} games-page page-wrapper flex flex-col gap-8`}>
      ...
      <div className='games-page__section --find-more-games'>
        <Link href={'/create/game'} className={`btn button-breakpoints m-auto px-6 w-1/2 ${create_game_button_style}`} onClick={() => {canMakeGame ? toast.success('permission true') : toast.error('you do not have permission to make a new game')}}>create a game</Link>
        <Link href={'/discover'} className='btn btn-primary button-breakpoints m-auto w-1/2 md:px-6 txt-3xl'>find more games</Link>
