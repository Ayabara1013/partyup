...
export function MyGamesCard({className, ...props}) {
    return (
        <div className={`${className} my-games-card flex flex-col p-2 gap-2 rounded-xl items-center`}>
            ...
            <div className='my-games-card__description'>property vertical green battle highway herself hang satisfied
                package may doll town love break lungs round headed sun give what command came beauty fewer
            </div>
