...
export const content = {
    ...
    description: (
        <>
            <p className='text-justify'>Waking up on a strange planet, you find yourself in a strange situation. You
                have no memory where you are, or how you got here. You are not alone, however. There are others here,
                and they seem to be in the same situation as you. You must work together to survive, and to find a way
                home.</p>
            <p className='text-center'>Or so you though. You have been abducted along with a SIXTH of the world's
                population to take part in the most popular gameshow in the galaxy;</p>
