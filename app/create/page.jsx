            ...
            <Blocks.Section>
                ...
                <div className='m-auto'>
                    ...
                    <ul className='flex gap-2'>
                        <li>
                            <button className='btn btn-primary'>a character to play</button>
                        </li>
                        <li>
                            <button className='btn btn-primary'>a game for me and my friends</button>
                        </li>
                        <li>
                            <button className='btn btn-primary'>a world to play in</button>
                        </li>
                        <li>
                            <button className='btn btn-primary'>a community to share</button>
                        </li>
                    </ul>
                </div>
            </Blocks.Section>
            ...
            <Blocks.Section className=''>
                ...
                <div className='flex text-center justify-center items-center gap-4'>
                    ...
                    <div className='w-1/3 '>
                        ...
                        <input type="text" placeholder="tell me something about your character!"
