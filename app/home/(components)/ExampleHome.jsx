...
export function ExampleHome({className = ''}) {
    ...
    return (
        <div className={`${className} example-home-layout relative flex flex-col p-8 gap-4 min-h-44 `}>
            ...
            {/* call to action */}
            <Home.Section id={`call-to-action`}
                          className={`call-to-action ${sectionStyles} text-4xl text-medium text-center`}>
            ...
            <Home.Section id={`big-landing-thing`} className={`justify-center ${sectionStyles}`}>
                ...
                <Home.Header className='font-borel lowercase'>System Agnostic, <span
                    className="underline font-borel">Life</span> Agnostic</Home.Header>
          ...
          <div className='system-example -5'>vamepiya te maskewade</div>
            ...
            <Home.Section id={`features`} className={`justify-center ${sectionStyles}`}>
                ...
                <Home.Header className='capitalize'><span className="underline">the</span> play-by-post
                    platform</Home.Header>

                <div className=''>
                    <div className='text-2xl font-bold text-secondary'>the complete virtual tabletop</div>

                    <p className='prw'>Roll20® is the most complete solution for digital play. Access character sheets,
                        tokens, rulebooks, dice, and more - with powerful tools to automate the tedious stuff.</p>
